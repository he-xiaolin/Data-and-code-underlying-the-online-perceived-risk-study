...
mkdir('processed_feature/HB/regression_input');
mkdir('processed_feature/HB/regression_label');
data_ = load(pt);
data = data_.HB;
...
File_name =append('processed_feature/HB/regression_input/HB_input_',num2str(i,'%02d'),'.mat');
save(File_name,'Time', ...
        'vx_s', 'vx_n', ...
        'ax_s' ,'ax_n' ,...
        'vy_s' ,'vy_n' , ...
...
for i = 1:27
    ...
    File_name =append('processed_feature/HB/regression_label/HB_rating_',num2str(i,'%02d'),'.mat');
