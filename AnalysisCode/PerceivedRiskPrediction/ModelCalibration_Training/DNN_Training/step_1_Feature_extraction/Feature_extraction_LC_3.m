...
mkdir('processed_feature/LC_3/regression_input');
mkdir('processed_feature/LC_3/regression_label');
data_ = load(pt);
data = data_.LC;
for i=19:24 %   LC_3 event order 13-18
...
File_name =append('processed_feature/LC_3/regression_input/LC_3_input_',num2str(i,'%02d'),'.mat');
save(File_name,'Time', ...
        'vx_s', 'vx_n', ...
        'ax_s' ,'ax_n' ,...
        'vy_s' ,'vy_n' , ...
...
j= 0;
for i = 19:24
    LC_3_rating = LC_PR(i).risk_p25_p75_mean;
    File_name =append('processed_feature/LC_3/regression_label/LC_3_rating_',num2str(i,'%02d'),'.mat');
    save(File_name,'LC_3_rating');
end
disp('LC_3 Done!')
