...
mkdir('processed_feature/LC_2/regression_input');
mkdir('processed_feature/LC_2/regression_label');
data_ = load(pt);
data = data_.LC;
for i=13:18 %   LC_2 event order 13-18
...
File_name =append('processed_feature/LC_2/regression_input/LC_2_input_',num2str(i,'%02d'),'.mat');
save(File_name,'Time', ...
        'vx_s', 'vx_n', ...
        'ax_s' ,'ax_n' ,...
        'vy_s' ,'vy_n' , ...
...
j= 0;
for i = 13:18
    LC_2_rating = LC_PR(i).risk_p25_p75_mean;
    File_name =append('processed_feature/LC_2/regression_label/LC_2_rating_',num2str(i,'%02d'),'.mat');
    save(File_name,'LC_2_rating');
end
disp('LC_2 Done!')
