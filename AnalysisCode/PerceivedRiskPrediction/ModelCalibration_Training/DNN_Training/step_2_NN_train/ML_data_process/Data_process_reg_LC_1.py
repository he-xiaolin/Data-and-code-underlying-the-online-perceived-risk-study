...
Input_Dic_name = '../../step_1_Feature_extraction/processed_feature/LC_1/regression_input/'
Label_Dic_name = '../../step_1_Feature_extraction/processed_feature/LC_1/regression_label/'

Input_File_name_list = os.listdir(Input_Dic_name)
Input_File_name_list.sort()
Input_File_name_list= [ i for i in Input_File_name_list if 'LC' in i ]

Label_File_name_list = os.listdir(Label_Dic_name)
Label_File_name_list.sort()
Label_File_name_list= [ i for i in Label_File_name_list if 'LC' in i ]
...
for ind, File_name in enumerate(Input_File_name_list):  # event files   1-27
    ...
    Label = np.transpose(mat_file_label['LC_1_rating'])
  ...
  # input feature      
    ...
    LC_feature_reg.append(comb_temp)
...
np.save('../data/LC_feature_reg_1.npy',LC_feature_reg)
