...
Input_Dic_name = '../../step_1_Feature_extraction/processed_feature/LC_2/regression_input/'
Label_Dic_name = '../../step_1_Feature_extraction/processed_feature/LC_2/regression_label/'
...
for ind, File_name in enumerate(Input_File_name_list):  # event files   1-27
    ...
    Label = np.transpose(mat_file_label['LC_2_rating'])
