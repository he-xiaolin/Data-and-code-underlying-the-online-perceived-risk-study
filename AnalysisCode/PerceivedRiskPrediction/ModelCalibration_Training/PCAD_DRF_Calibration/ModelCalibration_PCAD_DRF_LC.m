% This function is to calibrate DRF and PCAD in LC scenario. 
clear;clc;close all;
...
PR = [LC_PR.risk_p25_p75_mean];% No warped
len = length(x_s);
...
%% save
save('./CalibratedParameters_LC','results_DRF','results_PCAD','DRF','PCAD');