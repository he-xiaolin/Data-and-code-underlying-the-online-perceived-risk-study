...
# ---- CLI arguments ----
parser = argparse.ArgumentParser(description='SHAP for trained MC-Dropout model (LC_1)')
parser.add_argument('--scenario', type=str, default='LC_1', choices=['HB', 'MB', 'SVM', 'LC_1', 'LC_2', 'LC_3'])
...
# LC_1 feature names (from original script; fallback handled inside shap_cal if mismatch)
feature_names = [
    "$v_{x,s}$",
    "$v_{x,n}$",
    "$v_{y,n}$",
