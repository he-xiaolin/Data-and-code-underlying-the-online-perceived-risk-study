...
# ---- CLI arguments ----
parser = argparse.ArgumentParser(description='SHAP for trained MC-Dropout model (HB)')
parser.add_argument('--scenario', type=str, default='HB', choices=['HB', 'MB', 'SVM', 'LC_1', 'LC_2', 'LC_3'])
...
# HB feature names (fallback to generic if mismatch)
feature_names = [
    "$v_{x,s}$",
    "$v_{x,n}$",
    "$a_{x,s}$",
