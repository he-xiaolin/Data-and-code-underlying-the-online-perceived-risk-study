...
# ---- CLI arguments ----
parser = argparse.ArgumentParser(description='SHAP for trained MC-Dropout model (LC_2)')
parser.add_argument('--scenario', type=str, default='LC_2', choices=['HB', 'MB', 'SVM', 'LC_1', 'LC_2', 'LC_3'])
...
# LC_2 specifics (kept from your original MAL_2 script)
event_duration = 361
event_numb = 6
...
# LC_2 feature names (from your original MAL_2 file)
feature_names = [
    "$v_{x,s}$",
    "$v_{x,n}$",
    "$v_{y,n}$",
